  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
        <div className="text my-5 mr-1">
            ...
            <p className="text-xl my-7 px-1 dark:text-slate-300">OffTimeMaster est la première plateforme largement reconnue pour la gestion des congés. Numérisez en toute transparence votre processus de gestion des congés avec OffTimeMaster.</p>
