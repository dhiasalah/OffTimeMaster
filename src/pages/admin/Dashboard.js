...
import { collection,getCountFromServer,getDocs, limit, orderBy } from 'firebase/firestore';
...
export const Dashboard = () => {
    ...
    useEffect(()=>{
        ...
        const adminQuery=useRef(query( users,where("role","==","employe"),orderBy("firstname"),limit(3)));
        useEffect(()=>{
            async function getPosts(){
    ...
    const demandeRefuseQuery=query( collection(db,"users"),where("role","==","admin"));
       ...
       useEffect(()=>{
         ...
         const superAdminQuery=query( collection(db,"users"),where("role","==","admin"),where("super","==",true));
            ...
            useEffect(()=>{
              ...
              const employeQuery=query( collection(db,"users"),where("role","==","employe"));
            ...
            <div className="grid grid-cols-3 gap-4 mb-4"> 
                ...
                <div className="flex items-center gap-4 justify-center h-24 rounded bg-gray-100 dark:bg-gray-700">
                    ...
                    <div>
                        ...
                        <p className="text-4xl text-center font-thin text-gray-900 dark:text-white">{demandesAcceptesCount}</p>
                    </div>
                </div>
            ...
            <div className="flex items-center gap-4 justify-center h-24 rounded bg-gray-100 dark:bg-gray-700">
                ...
                <div className="flex items-center gap-4 justify-center h-24 rounded bg-gray-100 dark:bg-gray-700">
                    ...
                    <div>
                        ...
                        <p className="text-4xl text-center font-thin text-gray-900 dark:text-white">{superAdminCount}</p>
                    </div>
                </div>
